...
export default function DamAuthLayout({ children, title = "Hagrids", subtitle = "Secure, auditable, and controlled access to your enterprise databases and servers" }: AuthLayoutProps) {
