...
(function() {
  ...
  function QueryApp({ apiBaseUrl, freshdeskUser, client: client2 }) {
    ...
    const [selectedAssetId, setSelectedAssetId] = reactExports.useState(null);
    const [accessRequests, setAccessRequests] = reactExports.useState([]);
    ...
    const [queryResults, setQueryResults] = reactExports.useState(null);
    const [isLoading, setIsLoading] = reactExports.useState(false);
    const [isLoadingSchema, setIsLoadingSchema] = reactExports.useState(false);
    const [isReloadingAssets, setIsReloadingAssets] = reactExports.useState(false);
    ...
    const loadAssets = reactExports.useCallback(async (token, showLoading = false) => {
      if (!apiBaseUrl) {
    ...
    const authenticate = reactExports.useCallback(async () => {
      ...
      try {
        ...
        const errorMessage = (error == null ? void 0 : error.message) || ((_a = error == null ? void 0 : error.data) == null ? void 0 : _a.message) || "Failed to authenticate with Hagrids";
        setAuthError(errorMessage);
      } finally {
        setIsAuthenticating(false);
      }
    }, [apiBaseUrl, freshdeskUser == null ? void 0 : freshdeskUser.email, loadAssets]);
    ...
    const normalizeQueryResponse = reactExports.useCallback((data, originalQuery) => {
      let resultData = data;
    ...
    const runQuery = async () => {
      ...
      try {
        ...
        const errorMessage = (error == null ? void 0 : error.message) || ((_a = error == null ? void 0 : error.data) == null ? void 0 : _a.message) || "Failed to execute query";
    ...
    const handleTableClick = (tableName) => {
      ...
      const isMongoDB = (selectedAsset == null ? void 0 : selectedAsset.databaseType) === "MONGODB";
      const sampleQuery = isMongoDB ? `db.${tableName}.find({}).limit(10)` : `SELECT * FROM ${tableName} LIMIT 10;`;
      setQuery(sampleQuery);
    };
    const renderLoadingState = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "20px", textAlign: "center" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: "10px" }, children: "⏳" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Authenticating with Hagrids..." })
    ] });
    const renderErrorState = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "15px", color: "#d32f2f", background: "#fff", margin: "10px", borderRadius: "4px", border: "1px solid #ffcdd2" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: { marginBottom: "10px", fontSize: "14px" }, children: "Authentication Failed" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "12px", marginBottom: "10px", wordBreak: "break-word" }, children: authError }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: "11px", color: "#666", marginBottom: "15px" }, children: [
        "Please ensure:",
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { style: { marginTop: "5px", paddingLeft: "20px", lineHeight: "1.6", marginBottom: "15px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", justifyContent: "center", marginTop: "15px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => {
          ...
          type: "button",
          children: isAuthenticating ? "⏳ Retrying..." : "🔄 Retry Login"
        }
      ) })
    ] });
    if (isAuthenticating) {
    ...
    const renderAssetSelection = () => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "12px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "4px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "asset-select", style: { fontWeight: "600", fontSize: "12px" }, children: "Database Asset" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                isReloadingAssets ? "⏳" : "🔄",
                " ",
                isReloadingAssets ? "Loading..." : "Reload"
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "-- Select Asset --" }),
              assets.map((asset) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: asset.id, children: [
                asset.name,
                " (",
                asset.databaseType,
                ")"
        ...
        assets.length === 0 && !isReloadingAssets && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "4px", fontSize: "11px", color: "#666" }, children: "No assets available. Request access from an asset owner." })
      ] });
    };
    const renderAccessRequestSelection = () => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "12px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "request-select", style: { display: "block", marginBottom: "4px", fontWeight: "600", fontSize: "12px" }, children: "Access Request" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            id: "request-select",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "-- Select Request --" }),
              accessRequests.map((request) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: request.id, children: [
        ...
        accessRequests.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "4px", fontSize: "11px", color: "#f57c00" }, children: "No approved access requests for this asset." })
      ] });
    };
    const renderAssetDetails = () => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "12px", padding: "8px", background: "#f5f5f5", borderRadius: "4px", fontSize: "11px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Host:" }),
          " ",
          selectedAsset.hostAddress,
          ":",
          selectedAsset.portNumber
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Database:" }),
          " ",
          selectedAsset.databaseName || "N/A"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Type:" }),
          " ",
          selectedAsset.databaseType
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Username:" }),
          " ",
          selectedRequest.requestedUsername
        ] }),
        selectedRequest.expiryDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    const renderSchemaTableItem = (table, styles) => {
      ...
      const columnCount = table.columnCount || ((_a = table.columns) == null ? void 0 : _a.length) || 0;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            "📁 ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: table.tableName }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#666", marginLeft: "4px" }, children: [
              "(",
              columnCount,
              " cols)"
            ] }),
            table.tableType === "VIEW" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#9c27b0", marginLeft: "4px" }, children: "[VIEW]" })
          ]
        },
        table.tableName
      );
    ...
    const renderSchemaBrowser = () => {
      if (isLoadingSchema) {
        const styles2 = getSchemaBrowserStyles();
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          marginBottom: styles2.marginBottom,
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          remainingCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
            color: "#666",
            fontStyle: "italic",
            padding: styles.tablePadding
          }, children: [
    ...
    const renderQueryEditor = () => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "12px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "query-textarea", style: { display: "block", marginBottom: "4px", fontWeight: "600", fontSize: "12px" }, children: isMongoDB ? "MongoDB Query" : "SQL Query" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            ...
            placeholder: isMongoDB ? "db.collection.find({}).limit(10)" : "SELECT * FROM table_name LIMIT 10;",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: isLoading ? "⏳ Running..." : "▶ Run Query"
          }
        )
      ] });
    };
    const renderQueryResultsTable = () => {
      ...
      if (!queryResults.headers || !Array.isArray(queryResults.headers) || queryResults.headers.length === 0) {
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "10px", background: "#fff3cd", borderRadius: "4px", border: "1px solid #ffc107", fontSize: "12px" }, children: [
          "⚠️ Query executed but no results structure found. Check console for response details.",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "5px", fontSize: "10px", color: "#666" }, children: [
            "Response: ",
            JSON.stringify(queryResults, null, 2).substring(0, 200),
            "..."
          ] })
        ] });
      }
      const rowCount = ((_a = queryResults.data) == null ? void 0 : _a.length) || 0;
      const hasMoreRows = rowCount > 100;
      const displayData = (queryResults.data || []).slice(0, 100);
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { style: { marginBottom: "8px", fontSize: "13px", fontWeight: "600" }, children: [
          "📊 Results (",
          rowCount,
          " rows)"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { overflowX: "auto", maxHeight: isFullScreen ? "600px" : "300px", overflowY: "auto" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: isFullScreen ? "12px" : "10px", background: "white" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { style: { background: "#f5f5f5", position: "sticky", top: 0 }, children: queryResults.headers.map((header) => /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { padding: "5px 6px", border: "1px solid #ddd", textAlign: "left", fontWeight: "600", whiteSpace: "nowrap" }, children: String(header) }, String(header))) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: displayData.map((row, rIdx) => {
              const firstHeader = queryResults.headers[0];
              const rowKey = firstHeader && row[firstHeader] !== void 0 ? `row-${String(row[firstHeader])}-${rIdx}` : `row-${rIdx}`;
              return /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { style: { background: rIdx % 2 === 0 ? "white" : "#fafafa" }, children: queryResults.headers.map((header) => {
                const cellValue = row[header] ?? "";
                return /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "4px 6px", border: "1px solid #ddd", maxWidth: "200px", overflow: "hidden", textOverflow: "ellipsis" }, children: String(cellValue) }, `${String(header)}-${rowKey}`);
              }) }, rowKey);
            }) })
          ] }),
          hasMoreRows && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: "5px", fontSize: "10px", color: "#666", textAlign: "center" }, children: [
            "Showing first 100 of ",
            rowCount,
            " rows"
          ] }),
          rowCount === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "10px", textAlign: "center", color: "#666", fontSize: "11px" }, children: "No rows returned" })
        ] })
      ] });
    };
    const renderQueryResults = () => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "12px" }, children: renderQueryResultsTable() });
    };
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: containerStyle, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: isFullScreen ? "20px" : "12px", flexDirection: "column" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { margin: 0, fontSize: isFullScreen ? "24px" : "15px", fontWeight: "bold", color: "#1976d2", marginBottom: "5px" }, children: "🗄️ Database Query" }),
        !isFullScreen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Full Screen" })
            ]
          }
        ),
      ...
      renderQueryEditor(),
      renderQueryResults(),
      !selectedAssetId && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "15px", background: "#e3f2fd", borderRadius: "4px", color: "#1565c0", fontSize: "12px", textAlign: "center" }, children: "👆 Select a database asset to start querying" })
    ] });
  }
  QueryApp.propTypes = {
    ...
    // Freshworks client (optional, not used for API calls)
  };
